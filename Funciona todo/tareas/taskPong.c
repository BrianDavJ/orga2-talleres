...
/* PELOTA
 * Una pelota tiene una posición en la pantalla y una velocidad (con dirección!)
 */
typedef struct {
	int32_t x, y;
	int32_t dx, dy;
...
/* JUEGO
 * Una partida de pong consiste de un par de jugadores, una pelota y un estado del juego.
...
/* ACTUALIZA SCORE EN PANTALLA COMPRATIDA
