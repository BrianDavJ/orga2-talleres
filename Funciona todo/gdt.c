...
gdt_entry_t gdt[GDT_COUNT] = {
    ...
    [GDT_IDX_CODE_0] =
        ...
        [GDT_IDX_VIDEO]=
        {
            ...
            .dpl = 0x03,    
            .p = 1,
            .limit_19_16 = GDT_LIMIT_HIGH(GDT_LIMIT_BYTES(VIDEO_SEGM_SIZE)), // antees estaba en flat segment size
            .avl = 0x01,    // antes era 0
            .l = 0x00,
            .db = 0x01,
            .g = 0x00,
            .base_31_24 = GDT_BASE_HIGH(GDT_LIMIT_BYTES(VIDEO_SEGM_SIZE)),// antes era 0   
        }
    /* Completar la GDT: 
